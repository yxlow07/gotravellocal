...
if ($_POST) {
    ...
    if ($user->emailExists()) {
        ...
        if ($user->create()) {
            ...
            $body = "Thanks, {$send_to_email} for signing up.<br /><br />";
            $body .= "Please click the following link to verify your email and login: <br />";
            $body .= "<a href='{$home_url}verify/?access_code={$access_code}'><button style='background-color: blue; border-radius: 15px; color: white; padding:3px;'>Verify your email</button></a>";
