...
if ($_POST) {
    ...
    if ($user->emailExists()) {
        ...
        if ($user->updateAccessCode()) {
            ...
            $body .= "<a href='{$home_url}reset_password/?access_code={$access_code}'>{$home_url}reset_password/?access_code={$access_code}</a>";
    ...
    // message if email does not exist
        ...
        echo "<div class='alert alert-danger' align=\"center\">Your email cannot be found. Please register first.</div>";
    }
...
echo "<div class='account-wall' style='background-color: black; border-radius: 20px;'>
        <div id='my-tab-content' class='tab-content'>
            <div class='tab-pane active' id='login'>
                <img class='profile-img' src='images/login_icon.png'>
